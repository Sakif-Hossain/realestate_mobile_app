  ...
  return (
    ...
    >
      ...
      <View className="flex flex-row items-center bg-white/95 px-3 py-1.5 rounded-full absolute top-5 right-5">
        ...
        <Text className="text-xs font-bold text-primary-300 ml-1">
          {rating}
        </Text>
      </View>
      <View className="flex flex-col items-start absolute bottom-5 inset-x-5">
        ...
        <Text className="text-sm font-normal text-white">{address}</Text>
  ...
  return (
    ...
    >
      <View className="flex flex-row items-center absolute px-2 top-5 right-5 bg-white/90 p-1 rounded-full z-50">
        ...
        <Text className="text-xs font-bold text-primary-300 ml-0.5">
          {rating}
        </Text>
      </View>
      <Image source={{ uri: image }} className="w-full h-40 rounded-lg" />
      <View className="flex flex-col mt-2">
        <Text className="text-base text-black-300 font-bold">{name}</Text>
        <Text className="text-xs font-normal text-black-200">{address}</Text>
